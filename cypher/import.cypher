...
LOAD CSV WITH HEADERS FROM "file:///calling_points.csv" AS row
CALL {
    WITH row
...
LOAD CSV WITH HEADERS FROM "file:///calling_point_seq.csv" AS row
...
LOAD CSV WITH HEADERS FROM "file:///stop_seq.csv" AS row
...
LOAD CSV WITH HEADERS FROM "file:///calls_at.csv" AS row
...
LOAD CSV WITH HEADERS FROM "file:///calling_point_stops.csv" AS row
